    ...
    <>
      ...
      <nav className="sticky top-0 z-40 flex items-center justify-between px-6 py-3.5"
        ...
        <div className="flex items-center gap-6">
          ...
          <button onClick={() => router.push('/login')} className="px-5 py-2.5 rounded-lg font-syne font-bold text-black text-sm"
        ...
        <div className="relative max-w-5xl mx-auto grid grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex gap-3 flex-wrap mb-6">
              <button onClick={() => router.push('/login')} className="px-8 py-4 rounded-xl font-syne font-bold text-black"
                style={{ background: "linear-gradient(135deg,#f59e0b,#d97706)", fontSize: 15, cursor: "pointer" }}>
                🚀 7 Días Gratis
              </button>
              <button onClick={() => window.open('https://youtube.com', '_blank')} className="px-7 py-4 rounded-xl font-medium text-sm"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-3 gap-4 text-left">
            ...
            <div className="rounded-2xl p-7" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)" }}>
              ...
              <button onClick={() => router.push('/login')} className="w-full py-3.5 rounded-xl font-medium text-sm mt-5"
                style={{ background: "transparent", color: "#e0d9c8", border: "1px solid rgba(255,255,255,0.12)", cursor: "pointer" }}>
                Empezar gratis
              </button>
            </div>
            ...
            <div className="rounded-2xl p-7 relative" style={{ background: "rgba(245,158,11,0.06)", border: "2px solid #f59e0b" }}>
              ...
              <button onClick={() => router.push('/pricing')} className="w-full py-3.5 rounded-xl font-syne font-bold text-black text-sm mt-5"
            ...
            <div className="rounded-2xl p-7" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(168,85,247,0.2)" }}>
              ...
              <button onClick={() => router.push('/pricing')} className="w-full py-3.5 rounded-xl font-medium text-sm mt-5"
      ...
      <section className="px-6 py-20 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <button onClick={() => router.push('/login')} className="px-14 py-5 rounded-xl font-syne font-bold text-black"
